class room1 extends Phaser.Scene {
  ...
  create() {
    ...
    let powder1 = map.findObject(
      "ObjectLayer1",
      (obj) => obj.name === "powder1"
    );
    this.Powder = this.physics.add
    ...
    let gasoline = map.findObject(
      "ObjectLayer1",
      (obj) => obj.name === "gasoline"
    );
    ...
    let gasoline1 = map.findObject(
      "ObjectLayer1",
      (obj) => obj.name === "gasoline1"
    );
    ...
    let gasoline2 = map.findObject(
      "ObjectLayer1",
      (obj) => obj.name === "gasoline2"
    );
    ...
    let butter1 = map.findObject(
      "ObjectLayer1",
      (obj) => obj.name === "butter1"
    );
    this.Butter = this.physics.add
    ...
    if (this.cursors.left.isDown) {
      ...
      this.player.body.setVelocity(0, 0);
        ...
        if (
          ...
          if (window.powder > 1 && window.butter > 1) {
