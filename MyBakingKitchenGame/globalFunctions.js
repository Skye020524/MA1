...
function updateInventory() {
  ...
  this.inventory = {}
  this.inventory.milk = window.milk
  this.inventory.sugar = window.sugar
  this.inventory.butter = window.butter
  this.inventory.egg = window.egg
  this.inventory.powder = window.powder
...
// 
///////////////////////////////////////////////////////
function globalHitBrokenegg(player,item) {
