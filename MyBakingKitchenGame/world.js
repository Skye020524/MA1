class world extends Phaser.Scene {
  ...
  create() {
    ...
    // this.player.body.setSize(64 * 0.8, 64 * 0.8);
    ...
    let brokenegg = map.findObject(
      "ObjectLayer1",
      (obj) => obj.name === "brokenegg"
    );
    ...
    let brokenegg1 = map.findObject(
      "ObjectLayer1",
      (obj) => obj.name === "brokenegg1"
    );
    ...
    let brokenegg2 = map.findObject(
      "ObjectLayer1",
      (obj) => obj.name === "brokenegg2"
    );
  ...
  update() {
    ...
    if (this.cursors.left.isDown) {
      ...
      if (this.player.x > 880 && this.player.y > 1200 && this.player.y < 1300) {
        if (window.egg > 5 && window.milk > 0) {
